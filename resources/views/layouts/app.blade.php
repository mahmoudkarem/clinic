  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a style="text-decoration: none" href="mailto:contact@example.com">contact@example.com</a>
  ...
  <!-- ======= End Top Bar ======= -->
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
          ...
          <a style="text-decoration: none" href="{{route('find_doctor')}}" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span> Appointment</a>
          <a style="text-decoration: none" href="{{route('find_doctor')}}"  class="btn btn-success mx-3 ">Find Doctor</a>
